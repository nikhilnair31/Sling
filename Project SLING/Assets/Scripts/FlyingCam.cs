...
public class FlyingCam : MonoBehaviour {
	...
	public Joystick movingJoystick,lookingJoystick;
	private Vector3 moveVector;
	private Rigidbody RGB;
	public float moveSpeed = 50.0f; //regular speed
	...
	void FixedUpdate () {
		moveVector = (Vector3.right * movingJoystick.Horizontal + Vector3.forward * movingJoystick.Vertical);
